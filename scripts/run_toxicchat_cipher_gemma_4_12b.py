...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run ToxicChat Cipher Benchmark on Gemma 4 12B IT",
...
Examples:
  python scripts/run_toxicchat_cipher_gemma_4_12b.py leetcode
  python scripts/run_toxicchat_cipher_gemma_4_12b.py base64
  python scripts/run_toxicchat_cipher_gemma_4_12b.py --cipher rot13 --filter malicious
        """
    )
    parser.add_argument(
        "arg1",
...
def main():
    ...
    model_path = project_root / "models" / "gemma-4-12B-it-Q4_K_M.gguf"
