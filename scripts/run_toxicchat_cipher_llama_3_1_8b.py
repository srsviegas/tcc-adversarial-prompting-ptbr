...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run ToxicChat Cipher Benchmark on Meta Llama 3.1 8B Instruct",
...
Examples:
  python scripts/run_toxicchat_cipher_llama_3_1_8b.py leetcode
  python scripts/run_toxicchat_cipher_llama_3_1_8b.py base64
  python scripts/run_toxicchat_cipher_llama_3_1_8b.py --cipher rot13 --filter malicious
        """
    )
    parser.add_argument(
        "arg1",
