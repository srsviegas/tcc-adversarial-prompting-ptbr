...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run ToxicChat Cipher Benchmark on Qwen3 14B",
...
Examples:
  python scripts/run_toxicchat_cipher_qwen3_14b.py leetcode
  python scripts/run_toxicchat_cipher_qwen3_14b.py base64
  python scripts/run_toxicchat_cipher_qwen3_14b.py --cipher rot13 --filter malicious
        """
    )
    parser.add_argument(
        "arg1",
...
def main():
    ...
    model_path = project_root / "models" / "Qwen3-14B-Q4_K_M.gguf"
